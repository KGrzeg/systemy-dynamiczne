...
%t = 0:T:10*P-T;  %nale¿y zadbaæ aby koniec przedzia³u czasu = P-T
% % lub alternatywnie
okr = 10;
...
DFT_Y = fft(yn,N);   %DFT sygna³u - N wartoœci zespolonych
...
table(Y0_t,Y0_f, Yrms_t, Yrms_f, Y1rms_f, Y1_f)
